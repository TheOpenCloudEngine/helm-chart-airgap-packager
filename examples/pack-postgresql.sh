#!/usr/bin/env bash
# Example: Pack PostgreSQL Operator 1.28.1 (cnpg/cloudnative-pg chart 0.27.1) for airgap deployment
#
# Source command:
#   helm repo add cnpg https://cloudnative-pg.github.io/charts
#   helm pull cnpg/cloudnative-pg --version 0.27.1
#
# Note: After deploying the operator, create a Cluster CRD to provision PostgreSQL instances.
...
echo ""
echo "==> Packing PostgreSQL 17 Operator (chart 0.27.1)..."
